...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/ZHJZ-main/pages/leave/leave.vue"]]);
wx.createPage(MiniProgramPage);
=======
"use strict";const e=require("../../common/vendor.js"),r={data(){return{currentIndex:0,formData:{place:"",detail:"",reason:"",days:"",date:""}}},onLoad(){},methods:{change(a){this.currentIndex=a},submit(){e.index.showToast({title:"提交成功！",icon:"success",success:()=>{setTimeout(()=>{e.index.navigateBack()},500)}})},bigChange(){e.index.navigateTo({url:"/pages/approveQuery/approveQuery"})}}};if(!Array){const a=e.resolveComponent("uni-forms-item"),t=e.resolveComponent("uni-easyinput"),s=e.resolveComponent("uni-datetime-picker"),i=e.resolveComponent("uni-forms");(a+t+s+i)()}const m=()=>"../../uni_modules/uni-forms/components/uni-forms-item/uni-forms-item.js",c=()=>"../../uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.js",l=()=>"../../uni_modules/uni-datetime-picker/components/uni-datetime-picker/uni-datetime-picker.js",p=()=>"../../uni_modules/uni-forms/components/uni-forms/uni-forms.js";Math||(m+c+l+p)();function _(a,t,s,i,n,o){return{a:e.n(n.currentIndex===0?"nav-actived":""),b:e.o(u=>o.change(0)),c:e.n(n.currentIndex===1?"nav-actived":""),d:e.o(u=>o.change(1)),e:e.o((...u)=>o.bigChange&&o.bigChange(...u)),f:n.formData.place,g:e.o(u=>n.formData.place=u.detail.value),h:e.p({label:"外出目的地（乡镇、街道）",name:"place"}),i:e.o(u=>n.formData.detail=u),j:e.p({type:"text",placeholder:"请输入外出目的地明细",modelValue:n.formData.detail}),k:e.p({label:"目的地明细",name:"detail"}),l:e.o(u=>n.formData.reason=u),m:e.p({type:"text",placeholder:"请输入外出理由",modelValue:n.formData.reason}),n:e.p({label:"外出理由",name:"reason"}),o:e.o(u=>n.formData.days=u),p:e.p({type:"number",placeholder:"请输入外出天数",modelValue:n.formData.days}),q:e.p({label:"外出天数",name:"days"}),r:e.o(u=>n.formData.date=u),s:e.p({type:"daterange",modelValue:n.formData.date}),t:e.p({label:"外出日期",name:"date"}),v:e.p({modelValue:n.formData,["label-position"]:"top",["label-width"]:"1000rpx"}),w:e.o((...u)=>o.submit&&o.submit(...u)),x:n.currentIndex}}const d=e._export_sfc(r,[["render",_],["__file","C:/Users/lcz/Documents/GitHub/ZHJZ/pages/leave/leave.vue"]]);wx.createPage(d);
