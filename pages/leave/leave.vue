<template>
	<view class="yy">
		<!-- 		<view class="a">
			<button class="button" :class="currentIndex === 0 ? 'nav-actived' : ''" @click="change(0)">提交信息</button>
		...
		<view class="" v-if="tabbarIndex==1">
			...
			<view class="ss" @click="showTag">{{flag?"已经到底啦":"查看全部"}}</view>
		</view>
		...
		data() {
			return {
				...
				list1: [{
						title: "审批事项：外出请假",
						text: "外出目的地：江苏省太仓市",
						text1: "时间：2023.07.01-2023.07.06"
					},
					{
						title: "审批事项：外出请假",
						text: "外出目的地：江苏省南京市",
